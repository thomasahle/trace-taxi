...
<Card class="sticky top-6 h-[calc(100vh-3rem)] overflow-auto pr-1">
  <div class="p-3.5 border-b border-border">
    <div class="text-xs font-semibold text-muted-foreground uppercase tracking-wide mb-1.5">Trace</div>
    <h4 class="m-0 font-semibold">{data.title}</h4>
  </div>
  <div class="p-3.5 border-b border-border">
    <div class="text-xs font-semibold text-muted-foreground uppercase tracking-wide">Tools</div>
  ...
  <div class="p-3.5">
    <div class="text-xs font-semibold text-muted-foreground uppercase tracking-wide">Events</div>
    <div class="text-sm text-muted-foreground mt-2">{data?.events?.length ?? 0} total</div>
  </div>
</Card>
